...
namespace _ProjectFiles.Scripts.SamTestLogic {
    public class RelaxingTimer : MonoBehaviour {
        ...
        private void SetUpTimer(float optionalTimerStart = 60)
        {
            ...
            if (isGUIEnable==true)
            {
                ...
                _timerTextBox.text = "Please relax for"+ optionalTimerStart.ToString(CultureInfo.InvariantCulture)+" "+"seconds";
            }
        }
        ...
        public void CountDownTime(float optionalTimerSpeed = 1, float optionalTimerTolerance = 0, bool optionalIsAutomaticTimer = true) 
        {
            ...
            if (isGUIEnable == true)
            {
                ...
                _timerTextBox.text = "Please relax for " + Mathf.RoundToInt(currentTime).ToString(CultureInfo.InvariantCulture) +" "+"seconds" +" "+"and fill the sam after" ;
            }
        }
