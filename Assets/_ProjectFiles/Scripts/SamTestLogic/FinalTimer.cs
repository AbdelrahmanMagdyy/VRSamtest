    ...
    public class FinalTimer : MonoBehaviour {
        ...
        private void SetUpTimer(float optionalTimerStart = 60)
        {
            ...
            if (isGUIEnable==true)
            {
                ...
                _timerTextBox.text = "Break Time"+ "\n" + "Relax for" + optionalTimerStart.ToString(CultureInfo.InvariantCulture)+" "+"Or take off the VR headset if you need" ;
            }
        }
        ...
        public void CountDownTime(float optionalTimerSpeed = 1, float optionalTimerTolerance = 0, bool optionalIsAutomaticTimer = true) 
        {
            ...
            if (isGUIEnable == true)
            {
                ...
                _timerTextBox.text = "Break Time"+ "\n"+ "Relax for" +" " + Mathf.RoundToInt(currentTime).ToString(CultureInfo.InvariantCulture) +" "+ "seconds" +"  and continue"+"\n "+"Or take off the VR headset if you need" ;
            }
        }
